...
all() {
	load_base cborgmulti_internet localhost cyborg c7b8rg
	load_base cborgmulti_garagecloud localhost cyborg c7b8rg
	override cborgmulti_garagecloud localhost cyborg c7b8rg
}
