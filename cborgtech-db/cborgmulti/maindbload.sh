...
all() {
	load_main cborgmulti_main localhost cyborg c7b8rg
	load_security cborgmulti_main_internet localhost cyborg c7b8rg
	load_security cborgmulti_main_garagecloud localhost cyborg c7b8rg
	}
