...
all() {
	load_main cborgmicro_main localhost cyborg c7b8rg
	load_security cborgmicro_main_internet localhost cyborg c7b8rg
	load_security cborgmicro_main_garagecloud localhost cyborg c7b8rg
	}
