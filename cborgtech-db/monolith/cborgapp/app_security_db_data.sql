...
INSERT INTO user_role (user_id,role_id,sort_order) SELECT id,(SELECT id FROM role WHERE code='A' AND application_id = (SELECT id FROM application WHERE code = 'APP_RAPID')),1 FROM users WHERE username='toasthubadmin';
INSERT INTO user_role (user_id,role_id,sort_order) SELECT id,(SELECT id FROM role WHERE code='M' AND application_id = (SELECT id FROM application WHERE code = 'APP_RAPID')),2 FROM users WHERE username='toasthubadmin';
INSERT INTO user_role (user_id,role_id,sort_order) SELECT id,(SELECT id FROM role WHERE code='A' AND application_id = (SELECT id FROM application WHERE code = 'APP_BUGDOG')),1 FROM users WHERE username='toasthubadmin';
INSERT INTO user_role (user_id,role_id,sort_order) SELECT id,(SELECT id FROM role WHERE code='M' AND application_id = (SELECT id FROM application WHERE code = 'APP_BUGDOG')),2 FROM users WHERE username='toasthubadmin';
