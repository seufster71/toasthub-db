...
INSERT INTO pref_label_name (pref_name_id,name,text_id,group_name,optional_params,sort_order) VALUES((SELECT id FROM pref_name WHERE name = 'PM_DEPLOY_PAGE'),'PM_DEPLOY_TABLE_OPTIONS',@lastid,'TABLE1','{"fieldIcon":[{"code":"MODIFY","classField":"fa-regular fa-pen-to-square thub-1","permission":{"ARER":"R"},"label":{"en":"Modify"}},{"code":"DELETE","classField":"fa-regular fa-trash-can thub-1","permission":{"ARDR":"W"},"label":{"en":"Delete"}},{"code":"SHARE","classField":"fa-solid fa-share-nodes thub-1","permission":{"ARDR":"W"},"label":{"en":"Share"}},{"code":"PIPELINE","classField":"fa-solid fa-code-fork thub-1","permission":{"ARDR":"W"},"label":{"en":"Pipeline"}},{"code":"SYSTEM","classField":"fa-solid fa-server thub-1","permission":{"ARDR":"W"},"label":{"en":"Servers"}},{"code":"PROCESSOR","classField":"fa-solid fa-person-digging thub-1","permission":{"ARDR":"W"},"label":{"en":"Job processor"}},{"code":"TESTCASE","classField":"fa-solid fa-microscope thub-1","permission":{"ARDR":"W"},"label":{"en":"Test Cases"}},{"code":"HISTORY","classField":"fa-solid fa-timeline thub-1","permission":{"ARDR":"W"},"label":{"en":"History"}},{"code":"BUILD","classField":"fa-solid fa-person-running thub-1","permission":{"ARDR":"W"},"label":{"en":"Build"}}]}',6);
