...
INSERT INTO pref_form_field_name (pref_name_id,name,text_id,field_type,html_type,row_count,column_count,class_name,group_name,sub_group_name,class_model,sort_order) VALUES((SELECT id FROM pref_name WHERE name = 'PM_MEMBER_FORM'),'PM_MEMBER_FORM_USERNAME',@lastid,'ASLT','text',0,0,null,'FORM1',null,'{"clazz":"org.toasthub.pm.model.Member","method":"setUserId","type":"Long","field":"userId","allowModify":false,"displayField":"name"}',0);
...
INSERT INTO pref_form_field_name (pref_name_id,name,text_id,field_type,html_type,row_count,column_count,class_name,group_name,sub_group_name,class_model,sort_order) VALUES((SELECT id FROM pref_name WHERE name = 'PM_MEMBER_FORM'),'PM_MEMBER_FORM_TYPE',@lastid,'SLT','select',0,0,null,'FORM1',null,'{"clazz":"org.toasthub.pm.model.Member","method":"setType","type":"String","field":"type"}',1); 
INSERT INTO pref_form_field_value (pref_form_field_name_id,field_value,field_label,lang,rendered,required,validation) VALUES ((SELECT id FROM pref_form_field_name WHERE name = 'PM_MEMBER_FORM_TYPE'),'{"options":[{"value":"INTERNAL","label":"Internal","defaultInd":true},{"value":"EXTERNAL","label":"External"}]}','Member type:','en',true,true,'');
INSERT INTO pref_form_field_value (pref_form_field_name_id,field_value,field_label,lang,rendered,required,validation) VALUES ((SELECT id FROM pref_form_field_name WHERE name = 'PM_MEMBER_FORM_TYPE'),'{"options":[{"value":"INTERNAL","label":"Interno","defaultInd":true},{"value":"EXTERNAL","label":"Externo"}]}','Tipo de miembro:','es',true,true,'');
...
INSERT INTO pref_label_value (pref_label_name_id,label_value,lang,rendered) VALUES ((SELECT id FROM pref_label_name WHERE name = 'PM_MEMBER_TABLE_USERNAME'),'User Name','en',true);
INSERT INTO pref_label_value (pref_label_name_id,label_value,lang,rendered) VALUES ((SELECT id FROM pref_label_name WHERE name = 'PM_MEMBER_TABLE_USERNAME'),'User Nombre','es',true);
...
INSERT INTO pref_label_name (pref_name_id,name,text_id,group_name,optional_params,sort_order) VALUES((SELECT id FROM pref_name WHERE name = 'PM_MEMBER_PAGE'),'PM_MEMBER_TABLE_OPTIONS',@lastid,'TABLE1','{"fieldIcon":[{"code":"MODIFY","classField":"fa-regular fa-pen-to-square thub-1","permission":{"ARER":"R"},"label":{"en":"Modify"}},{"code":"DELETE","classField":"fa-regular fa-trash-can thub-1","permission":{"ARDR":"W"},"label":{"en":"Delete"}},{"code":"ROLES","classField":"fa-solid fa-users-gear thub-1","permission":{"ARDR":"W"},"label":{"en":"Roles"}}]}',3);
