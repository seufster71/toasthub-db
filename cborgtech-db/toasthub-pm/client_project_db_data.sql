...
INSERT INTO pref_label_name (pref_name_id,name,text_id,group_name,optional_params,sort_order) VALUES((SELECT id FROM pref_name WHERE name = 'PM_PROJECT_PAGE'),'PM_PROJECT_TABLE_OPTIONS',@lastid,'TABLE1','{"fieldIcon":[{"code":"MODIFY","classField":"fa fa-pencil-square-o fa-1","permission":{"ARER":"R"},"label":{"en":"Modify"}},{"code":"DELETE","classField":"fa fa-trash fa-1","permission":{"ARDR":"W"},"label":{"en":"Delete"}},{"code":"SHARE","classField":"fa fa-share-alt fa-1","permission":{"ARDR":"W"},"label":{"en":"Share"}},{"code":"BACKLOG","classField":"fa fa-bold fa-1","permission":{"ARDR":"W"},"label":{"en":"Backlog"}},{"code":"RELEASE","classField":"fa fa-paper-plane fa-1","permission":{"ARDR":"W"},"label":{"en":"Release"}},{"code":"SCRUM","classField":"fa fa-circle-o-notch fa-1","permission":{"ARDR":"W"},"label":{"en":"Scrum"}},{"code":"DEFECT","classField":"fa fa-bug fa-1","permission":{"ARDR":"W"},"label":{"en":"Defect"}},{"code":"ENHANCEMENT","classField":"fa fa-building fa-1","permission":{"ARDR":"W"},"label":{"en":"Enhancement"}},{"code":"WORKFLOW","classField":"fa fa-code-fork fa-1","permission":{"ARDR":"W"},"label":{"en":"Workflow"}}]}',4);
