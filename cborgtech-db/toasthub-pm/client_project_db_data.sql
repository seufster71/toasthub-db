...
INSERT INTO pref_label_name (pref_name_id,name,text_id,group_name,optional_params,sort_order) VALUES((SELECT id FROM pref_name WHERE name = 'PM_PROJECT_PAGE'),'PM_PROJECT_TABLE_OPTIONS',@lastid,'TABLE1','{"fieldIcon":[{"code":"MODIFY","classField":"fa-regular fa-pen-to-square thub-1","permission":{"ARER":"R"},"label":{"en":"Modify"}},{"code":"DELETE","classField":"fa-regular fa-trash-can thub-1","permission":{"ARDR":"W"},"label":{"en":"Delete"}},{"code":"SHARE","classField":"fa-solid fa-share-nodes thub-1","permission":{"ARDR":"W"},"label":{"en":"Share"}},{"code":"BACKLOG","classField":"fa-solid fa-list thub-1","permission":{"ARDR":"W"},"label":{"en":"Backlog"}},{"code":"RELEASE","classField":"fa-solid fa-rocket thub-1","permission":{"ARDR":"W"},"label":{"en":"Release"}},{"code":"SCRUM","classField":"fa-solid fa-person-circle-check thub-1","permission":{"ARDR":"W"},"label":{"en":"Scrum"}},{"code":"DEFECT","classField":"fa-solid fa-bug thub-1","permission":{"ARDR":"W"},"label":{"en":"Defect"}},{"code":"ENHANCEMENT","classField":"fa-solid fa-person-digging thub-1","permission":{"ARDR":"W"},"label":{"en":"Enhancement"}},{"code":"WORKFLOW","classField":"fa-solid fa-code-fork thub-1","permission":{"ARDR":"W"},"label":{"en":"Workflow"}}]}',4);
