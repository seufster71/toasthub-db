...
INSERT INTO page_label_name (page_name_id,name,text_id,optional_params) VALUES((SELECT id FROM page_name WHERE name = 'ADMIN_MENU_TABLE'),'ADMIN_MENU_TABLE_STATUS',@lastid,'{"fieldBool":"active"}');
