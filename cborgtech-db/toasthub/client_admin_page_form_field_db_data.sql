...
INSERT INTO pref_form_field_name (pref_name_id,name,text_id,field_type,html_type,row_count,column_count,class_name,group_name,sub_group_name,class_model,optional_params) VALUES((SELECT id FROM pref_name WHERE name = 'ADMIN_FORMFIELD_PAGE'),'ADMIN_FORMFIELD_FORM_NAME_CODE',@lastid,'TXT','text',0,0,null,'FORM-NAME',null,'{"clazz":"org.toasthub.core.preference.model.PrefFormFieldName","field":"name","type":"String"}','{"modify":"disabled"}');
...
INSERT INTO pref_form_field_name (pref_name_id,name,text_id,field_type,html_type,row_count,column_count,class_name,group_name,sub_group_name,class_model) VALUES((SELECT id FROM pref_name WHERE name = 'ADMIN_FORMFIELD_PAGE'),'ADMIN_FORMFIELD_FORM_VALUE_VALUE',@lastid,'TXT','text',0,0,null,'FORM-NAME','MULTI-VALUES','{"clazz":"org.toasthub.core.preference.model.PrefFormFieldValue","field":"value","type":"String"}');
...
INSERT INTO pref_form_field_name (pref_name_id,name,text_id,field_type,html_type,row_count,column_count,class_name,group_name,sub_group_name,class_model) VALUES((SELECT id FROM pref_name WHERE name = 'ADMIN_FORMFIELD_PAGE'),'ADMIN_FORMFIELD_FORM_VALUE_LABEL',@lastid,'TXT','text',0,0,null,'FORM-NAME','MULTI-VALUES','{"clazz":"org.toasthub.core.preference.model.PrefFormFieldValue","field":"label","type":"String"}');
...
INSERT INTO pref_form_field_name (pref_name_id,name,text_id,field_type,html_type,row_count,column_count,class_name,group_name,sub_group_name,class_model) VALUES((SELECT id FROM pref_name WHERE name = 'ADMIN_FORMFIELD_PAGE'),'ADMIN_FORMFIELD_FORM_VALUE_RENDERED',@lastid,'BLN','radioH',0,0,null,'FORM-NAME','MULTI-VALUES','{"clazz":"org.toasthub.core.preference.model.PrefFormFieldValue","field":"rendered","type":"Boolean"}');
INSERT INTO pref_form_field_value (pref_form_field_name_id,field_value,field_label,lang,rendered,required,sort_order,validation) VALUES ((SELECT id FROM pref_form_field_name WHERE name = 'ADMIN_FORMFIELD_FORM_VALUE_RENDERED'),'{"options":[{"value":true,"label":"True","defaultInd":true},{"value":false,"label":"False"}]}','Rendered:','en',true,true,3,'');
INSERT INTO pref_form_field_value (pref_form_field_name_id,field_value,field_label,lang,rendered,required,sort_order,validation) VALUES ((SELECT id FROM pref_form_field_name WHERE name = 'ADMIN_FORMFIELD_FORM_VALUE_RENDERED'),'{"options":[{"value":true,"label":"Cierto","defaultInd":true},{"value":false,"label":"Falso"}]}','Rendido:','es',true,true,3,'');
...
INSERT INTO pref_form_field_name (pref_name_id,name,text_id,field_type,html_type,row_count,column_count,class_name,group_name,sub_group_name,class_model) VALUES((SELECT id FROM pref_name WHERE name = 'ADMIN_FORMFIELD_PAGE'),'ADMIN_FORMFIELD_FORM_VALUE_REQUIRED',@lastid,'BLN','radioH',0,0,null,'FORM-NAME','MULTI-VALUES','{"clazz":"org.toasthub.core.preference.model.PrefFormFieldValue","field":"required","type":"Boolean"}');
INSERT INTO pref_form_field_value (pref_form_field_name_id,field_value,field_label,lang,rendered,required,sort_order,validation) VALUES ((SELECT id FROM pref_form_field_name WHERE name = 'ADMIN_FORMFIELD_FORM_VALUE_REQUIRED'),'{"options":[{"value":true,"label":"True"},{"value":false,"label":"False","defaultInd":true}]}','Required:','en',true,true,4,'');
INSERT INTO pref_form_field_value (pref_form_field_name_id,field_value,field_label,lang,rendered,required,sort_order,validation) VALUES ((SELECT id FROM pref_form_field_name WHERE name = 'ADMIN_FORMFIELD_FORM_VALUE_REQUIRED'),'{"options":[{"value":true,"label":"Cierto"},{"value":false,"label":"Falso","defaultInd":true}]}','Necesario:','es',true,true,4,'');
