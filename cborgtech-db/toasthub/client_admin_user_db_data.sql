...
INSERT INTO page_form_field_name (page_name_id,name,text_id,field_type,html_type,row_count,column_count,class_name,group_name,sub_group_name,class_model) VALUES((SELECT id FROM page_name WHERE name = 'ADMIN_USER_FORM'),'ADMIN_USER_FORM_LANGUAGE',@lastid,'MDLSNG','select',0,0,null,'MAIN',null,'{"clazz":"org.toasthub.security.model.User","field":"lang","fieldChild":{"language":{"clazz":"org.toasthub.core.general.model.Langauge","type":"Object"}},"method":"setLang","type":"String"}');
INSERT INTO page_form_field_value (page_form_field_name_id,field_value,field_label,lang,rendered,required,sort_order,validation) VALUES ((SELECT id FROM page_form_field_name WHERE name = 'ADMIN_USER_FORM_LANGUAGE'),'{"options":[{"value":"en","label":"English","defaultInd":true},{"value":"es","label":"Spanish"}]}','Language:','en',true,true,7,'');
INSERT INTO page_form_field_value (page_form_field_name_id,field_value,field_label,lang,rendered,required,sort_order,validation) VALUES ((SELECT id FROM page_form_field_name WHERE name = 'ADMIN_USER_FORM_LANGUAGE'),'{"options":[{"value":"en","label":"English","defaultInd":true},{"value":"es","label":"Spanish"}]}','Idioma:','es',true,true,7,'');
...
INSERT INTO page_form_field_name (page_name_id,name,text_id,field_type,html_type,row_count,column_count,class_name,group_name,sub_group_name,class_model,optional_params) VALUES((SELECT id FROM page_name WHERE name = 'ADMIN_USER_FORM'),'ADMIN_USER_FORM_PASSWORD',@lastid,'TXT','password',0,0,null,'MAIN',null,'{"clazz":"org.toasthub.security.model.User","field":"password","type":"String","encrypt":true}','{"onChange":{"func":"passwordStrength"},"onBlur":{"func":"clearVerifyPassword"}}');
...
INSERT INTO page_form_field_name (page_name_id,name,text_id,field_type,html_type,row_count,column_count,class_name,group_name,sub_group_name,class_model,optional_params) VALUES((SELECT id FROM page_name WHERE name = 'ADMIN_USER_FORM'),'ADMIN_USER_FORM_VERIFY_PASSWORD',@lastid,'TXT','password',0,0,null,'MAIN',null,'{"clazz":"org.toasthub.security.model.User","field":"verifyPassword","type":"String","encrypt":true}','{"onBlur":{"validation":"matchField"}}');
INSERT INTO page_form_field_value (page_form_field_name_id,field_value,field_label,lang,rendered,required,sort_order,validation) VALUES ((SELECT id FROM page_form_field_name WHERE name = 'ADMIN_USER_FORM_VERIFY_PASSWORD'),'','Verify Password:','en',true,false,8,'{"matchField":{"id":"ADMIN_USER_FORM_PASSWORD","successMsg":"Password match","failMsg":"Password does not match"}}');
INSERT INTO page_form_field_value (page_form_field_name_id,field_value,field_label,lang,rendered,required,sort_order,validation) VALUES ((SELECT id FROM page_form_field_name WHERE name = 'ADMIN_USER_FORM_VERIFY_PASSWORD'),'','Verificar contraseña:','es',true,false,8,'{"matchField":{"id":"ADMIN_USER_FORM_PASSWORD","successMsg":"Password match","failMsg":"La contraseña no coincide"}}');
...
INSERT INTO page_form_field_value (page_form_field_name_id,field_value,field_label,lang,rendered,required,sort_order,validation) VALUES ((SELECT id FROM page_form_field_name WHERE name = 'ADMIN_USER_FORM_LOGLEVEL'),'{"options":[{"value":"OFF","text":"Off","defaultInd":true},{"value":"FATAL","text":"Fatal"},{"value":"ERROR","text":"Error"},{"value":"WARN","text":"Warning"},{"value":"INFO","text":"Info"},{"value":"DEBUG","text":"Debug"},{"value":"TRACE","text":"Trace"}]}','Log Level:','en',true,false,9,'');
INSERT INTO page_form_field_value (page_form_field_name_id,field_value,field_label,lang,rendered,required,sort_order,validation) VALUES ((SELECT id FROM page_form_field_name WHERE name = 'ADMIN_USER_FORM_LOGLEVEL'),'{"options":[{"value":"OFF","text":"Apagado","defaultInd":true},{"value":"FATAL","text":"Fatal"},{"value":"ERROR","text":"Error"},{"value":"WARN","text":"Advertencia"},{"value":"INFO","text":"Información"},{"value":"DEBUG","text":"Depurar"},{"value":"TRACE","text":"Rastro"}]}','Nivel de registro:','es',true,false,9,'');
...
INSERT INTO page_form_field_value (page_form_field_name_id,field_value,field_label,lang,rendered,required,sort_order,validation) VALUES ((SELECT id FROM page_form_field_name WHERE name = 'ADMIN_USER_FORM_ACTIVE'),'{"options":[{"value":true,"label":"Active","defaultInd":true},{"value":false,"label":"Disable"}]}','Active:','en',true,true,10,'');
...
INSERT INTO page_form_field_value (page_form_field_name_id,field_value,field_label,lang,rendered,required,sort_order,validation) VALUES ((SELECT id FROM page_form_field_name WHERE name = 'ADMIN_USER_FORM_FORCERESET'),'{"options":[{"value":true,"label":"Yes"},{"value":false,"label":"No","defaultInd":true}]}','Force password reset:','en',true,false,11,'');
INSERT INTO page_form_field_value (page_form_field_name_id,field_value,field_label,lang,rendered,required,sort_order,validation) VALUES ((SELECT id FROM page_form_field_name WHERE name = 'ADMIN_USER_FORM_FORCERESET'),'{"options":[{"value":true,"label":"Yes"},{"value":false,"label":"No","defaultInd":true}]}','Restablecer contraseña de la contraseña:','es',true,false,11,'');
