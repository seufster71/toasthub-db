...
INSERT INTO page_form_field_value (page_form_field_name_id,field_value,field_label,lang,rendered,required,sort_order,validation) VALUES ((SELECT id FROM page_form_field_name WHERE name = 'ADMIN_USER_FORM_LOGLEVEL'),'{"options":[{"value":"OFF","text":"Off","default":true},{"value":"FATAL","text":"Fatal"},{"value":"ERROR","text":"Error"},{"value":"WARN","text":"Warning"},{"value":"INFO","text":"Info"},{"value":"DEBUG","text":"Debug"},{"value":"TRACE","text":"Trace"}]}','Log Level:','en',true,false,9,'');
INSERT INTO page_form_field_value (page_form_field_name_id,field_value,field_label,lang,rendered,required,sort_order,validation) VALUES ((SELECT id FROM page_form_field_name WHERE name = 'ADMIN_USER_FORM_LOGLEVEL'),'{"options":[{"value":"OFF","text":"Apagado","default":true},{"value":"FATAL","text":"Fatal"},{"value":"ERROR","text":"Error"},{"value":"WARN","text":"Advertencia"},{"value":"INFO","text":"Información"},{"value":"DEBUG","text":"Depurar"},{"value":"TRACE","text":"Rastro"}]}','Nivel de registro:','es',true,false,9,'');
