...
INSERT INTO pref_name (pref_product_id,name,text_id,category) VALUES ((SELECT id FROM pref_product WHERE product_code = 'GLOBAL'),'LOGIN_FORM',@lastid,'PUBLIC');
...
INSERT INTO pref_label_name (pref_name_id,name,class_name,tab_index,text_id,sort_order) VALUES((SELECT id FROM pref_name WHERE name = 'LOGIN_FORM'),'LOGIN_FORM_SUBMIT_BUTTON','form-control btn btn-login',4,@lastid,0);
...
INSERT INTO pref_text_name (pref_name_id,name,text_id) VALUES((SELECT id FROM pref_name WHERE name = 'LOGIN_FORM'),'LOGIN_FORM_HEADER',@lastid);
...
INSERT INTO pref_text_name (pref_name_id,name,tab_index,text_id) VALUES((SELECT id FROM pref_name WHERE name = 'LOGIN_FORM'),'LOGIN_FORM_REMEMBER_ME',3,@lastid);
...
INSERT INTO pref_text_name (pref_name_id,name,tab_index,text_id) VALUES((SELECT id FROM pref_name WHERE name = 'LOGIN_FORM'),'LOGIN_FORM_FORGOT_PASSWORD',5,@lastid);
...
INSERT INTO langtexts (text_id,lang,text) VALUES (@lastid,'es','Se te olvidó tu contraseña');
INSERT INTO pref_text_name (pref_name_id,name,tab_index,text_id) VALUES((SELECT id FROM pref_name WHERE name = 'LOGIN_FORM'),'LOGIN_FORM_CHANGE_PASSWORD',6,@lastid);
...
INSERT INTO langtexts (text_id,lang,text) VALUES (@lastid,'es','Perdidos por el usuario');
INSERT INTO pref_text_name (pref_name_id,name,text_id) VALUES((SELECT id FROM pref_name WHERE name = 'LOGIN_FORM'),'LOGIN_FORM_USERMISSING',@lastid);
