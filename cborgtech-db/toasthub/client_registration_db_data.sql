...
INSERT INTO pref_name (pref_product_id,name,text_id,category) VALUES ((SELECT id FROM pref_product WHERE product_code = 'GLOBAL'),'REGISTRATION_FORM',@lastid,'PUBLIC');
...
INSERT INTO pref_form_field_name (pref_name_id,name,text_id,field_type,html_type,row_count,column_count,class_name,group_name,sub_group_name,class_model,sort_order) VALUES((SELECT id FROM pref_name WHERE name = 'REGISTRATION_FORM'),'REGISTRATION_FORM_ZIPCODE',@lastid,'TXT','text',2,25,null,'FORM1',null,'{"clazz":"org.toasthub.security.model.User","field":"zipcode","type":"String"}',4);
...
INSERT INTO pref_form_field_name (pref_name_id,name,text_id,field_type,html_type,row_count,column_count,class_name,group_name,sub_group_name,class_model,sort_order) VALUES((SELECT id FROM pref_name WHERE name = 'REGISTRATION_FORM'),'REGISTRATION_FORM_PASSWORD',@lastid,'TXT','password',2,25,null,'FORM1',null,'{"clazz":"org.toasthub.security.model.User","field":"password","type":"String"}',7);
...
INSERT INTO pref_label_name (pref_name_id,name,text_id,group_name,sort_order) VALUES((SELECT id FROM pref_name WHERE name = 'REGISTRATION_FORM'),'REGISTRATION_CHECKNAME_FORM_SEARCH_USERNAME_BUTTON',@lastid,'BUTTONGRP1',0);
...
INSERT INTO pref_label_name (pref_name_id,name,text_id,group_name,sort_order) VALUES((SELECT id FROM pref_name WHERE name = 'REGISTRATION_FORM'),'REGISTRATION_CHECKNAME_FORM_RESET_BUTTON',@lastid,'BUTTONGRP1',1);
...
INSERT INTO pref_label_name (pref_name_id,name,class_name,text_id,group_name,sort_order) VALUES((SELECT id FROM pref_name WHERE name = 'REGISTRATION_FORM'),'REGISTRATION_FORM_SUBMIT_BUTTON','form-control btn btn-register',@lastid,'BUTTONGRP2',0);
...
INSERT INTO pref_text_name (pref_name_id,name,text_id) VALUES((SELECT id FROM pref_name WHERE name = 'REGISTRATION_FORM'),'REGISTRATION_FORM_HEADER',@lastid);
...
INSERT INTO pref_text_name (pref_name_id,name,text_id) VALUES((SELECT id FROM pref_name WHERE name = 'REGISTRATION_FORM'),'REGISTRATION_FORM_SUCCESSFUL',@lastid);
...
INSERT INTO pref_text_name (pref_name_id,name,text_id) VALUES((SELECT id FROM pref_name WHERE name = 'REGISTRATION_FORM'),'REGISTRATION_FORM_FAILED',@lastid);
...
INSERT INTO pref_text_name (pref_name_id,name,text_id) VALUES((SELECT id FROM pref_name WHERE name = 'REGISTRATION_FORM'),'REGISTRATION_FORM_CAPITAL_CHECK',@lastid);
...
INSERT INTO pref_text_name (pref_name_id,name,text_id) VALUES((SELECT id FROM pref_name WHERE name = 'REGISTRATION_FORM'),'REGISTRATION_FORM_ALPHA_CHECK',@lastid);
...
INSERT INTO pref_text_name (pref_name_id,name,text_id) VALUES((SELECT id FROM pref_name WHERE name = 'REGISTRATION_FORM'),'REGISTRATION_FORM_NUMBER_CHECK',@lastid);
...
INSERT INTO pref_text_name (pref_name_id,name,text_id) VALUES((SELECT id FROM pref_name WHERE name = 'REGISTRATION_FORM'),'REGISTRATION_FORM_COUNT_CHECK',@lastid);
...
INSERT INTO pref_text_name (pref_name_id,name,text_id) VALUES((SELECT id FROM pref_name WHERE name = 'REGISTRATION_FORM'),'REGISTRATION_FORM_SPECIAL_CHECK',@lastid);
...
INSERT INTO pref_text_name (pref_name_id,name,text_id) VALUES((SELECT id FROM pref_name WHERE name = 'REGISTRATION_FORM'),'REGISTRATION_FORM_MATCH_CHECK',@lastid);
...
INSERT INTO pref_option_name (pref_name_id,name,text_id,value_type,default_value,use_default) VALUES((SELECT id FROM pref_name WHERE name = 'REGISTRATION_FORM'),'REGISTRATION_SHOW_FORM',@lastid,'Boolean','true',false);
