...
INSERT INTO pref_form_field_value (pref_form_field_name_id,field_value,field_label,lang,rendered,required,validation) VALUES ((SELECT id FROM pref_form_field_name WHERE name = 'SOCIAL_ACQUAINTANCE_EMAIL_INVITE_FORM_EMAIL'),'-Valid email address-','Email Address:','en',true,true,'');
INSERT INTO pref_form_field_value (pref_form_field_name_id,field_value,field_label,lang,rendered,required,validation) VALUES ((SELECT id FROM pref_form_field_name WHERE name = 'SOCIAL_ACQUAINTANCE_EMAIL_INVITE_FORM_EMAIL'),'-Dirección de email válida-','Dirección de correo electrónico:','es',true,true,'');
...
INSERT INTO pref_form_field_value (pref_form_field_name_id,field_value,field_label,lang,rendered,required,validation) VALUES ((SELECT id FROM pref_form_field_name WHERE name = 'SOCIAL_ACQUAINTANCE_EMAIL_INVITE_FORM_MESSAGE'),'-Join me on ToastHub-','Message:','en',true,true,'');
INSERT INTO pref_form_field_value (pref_form_field_name_id,field_value,field_label,lang,rendered,required,validation) VALUES ((SELECT id FROM pref_form_field_name WHERE name = 'SOCIAL_ACQUAINTANCE_EMAIL_INVITE_FORM_MESSAGE'),'-Únete a mí en ToastHub-','Mensaje:','es',true,true,'');
...
INSERT INTO pref_label_name (pref_name_id,name,text_id,group_name,sort_order) VALUES((SELECT id FROM pref_name WHERE name = 'SOCIAL_ACQUAINTANCE_PAGE'),'SOCIAL_ACQUAINTANCE_EMAIL_INVITE_SUBMIT_BUTTON',@lastid,'BUTTON_EMAIL_INVITE',0);
INSERT INTO pref_label_value (pref_label_name_id,label_value,lang,rendered) VALUES ((SELECT id FROM pref_label_name WHERE name = 'SOCIAL_ACQUAINTANCE_EMAIL_INVITE_SUBMIT_BUTTON'),'Submit','en',true);
INSERT INTO pref_label_value (pref_label_name_id,label_value,lang,rendered) VALUES ((SELECT id FROM pref_label_name WHERE name = 'SOCIAL_ACQUAINTANCE_EMAIL_INVITE_SUBMIT_BUTTON'),'Search es','es',true);
...
INSERT INTO pref_label_name (pref_name_id,name,text_id,group_name,sort_order) VALUES((SELECT id FROM pref_name WHERE name = 'SOCIAL_ACQUAINTANCE_PAGE'),'SOCIAL_ACQUAINTANCE_EMAIL_INVITE_RESET_BUTTON',@lastid,'BUTTON_EMAIL_INVITE',1);
INSERT INTO pref_label_value (pref_label_name_id,label_value,lang,rendered) VALUES ((SELECT id FROM pref_label_name WHERE name = 'SOCIAL_ACQUAINTANCE_EMAIL_INVITE_RESET_BUTTON'),'Reset','en',true);
INSERT INTO pref_label_value (pref_label_name_id,label_value,lang,rendered) VALUES ((SELECT id FROM pref_label_name WHERE name = 'SOCIAL_ACQUAINTANCE_EMAIL_INVITE_RESET_BUTTON'),'Reajustar','es',true);
...
INSERT INTO pref_form_field_value (pref_form_field_name_id,field_value,field_label,lang,rendered,required,validation) VALUES ((SELECT id FROM pref_form_field_name WHERE name = 'SOCIAL_ACQUAINTANCE_INVITE_FORM_RECEIVER_ID'),'','','en',true,true,'');
INSERT INTO pref_form_field_value (pref_form_field_name_id,field_value,field_label,lang,rendered,required,validation) VALUES ((SELECT id FROM pref_form_field_name WHERE name = 'SOCIAL_ACQUAINTANCE_INVITE_FORM_RECEIVER_ID'),'','','es',true,true,'');
...
INSERT INTO pref_form_field_value (pref_form_field_name_id,field_value,field_label,lang,rendered,required,validation) VALUES ((SELECT id FROM pref_form_field_name WHERE name = 'SOCIAL_ACQUAINTANCE_INVITE_FORM_MESSAGE'),'-I would like to connect-','Message:','en',true,true,'');
INSERT INTO pref_form_field_value (pref_form_field_name_id,field_value,field_label,lang,rendered,required,validation) VALUES ((SELECT id FROM pref_form_field_name WHERE name = 'SOCIAL_ACQUAINTANCE_INVITE_FORM_MESSAGE'),'-Me gustaría conectar-','Mensaje:','es',true,true,'');
...
INSERT INTO langtexts (text_id,lang,text) VALUES (@lastid,'en','Submit - Button');
INSERT INTO langtexts (text_id,lang,text) VALUES (@lastid,'es','Botón de enviar');
INSERT INTO pref_label_name (pref_name_id,name,text_id,group_name,sort_order) VALUES((SELECT id FROM pref_name WHERE name = 'SOCIAL_ACQUAINTANCE_PAGE'),'SOCIAL_ACQUAINTANCE_INVITE_SUBMIT_BUTTON',@lastid,'BUTTON_INVITE',0);
INSERT INTO pref_label_value (pref_label_name_id,label_value,lang,rendered) VALUES ((SELECT id FROM pref_label_name WHERE name = 'SOCIAL_ACQUAINTANCE_INVITE_SUBMIT_BUTTON'),'Submit','en',true);
INSERT INTO pref_label_value (pref_label_name_id,label_value,lang,rendered) VALUES ((SELECT id FROM pref_label_name WHERE name = 'SOCIAL_ACQUAINTANCE_INVITE_SUBMIT_BUTTON'),'Search es','es',true);

INSERT INTO texts (default_text) VALUES ('Reset - Button');
SET @lastid = LAST_INSERT_ID();
INSERT INTO langtexts (text_id,lang,text) VALUES (@lastid,'en','Reset - Button');
INSERT INTO langtexts (text_id,lang,text) VALUES (@lastid,'es','Botón de reinicio');
INSERT INTO pref_label_name (pref_name_id,name,text_id,group_name,sort_order) VALUES((SELECT id FROM pref_name WHERE name = 'SOCIAL_ACQUAINTANCE_PAGE'),'SOCIAL_ACQUAINTANCE_INVITE_RESET_BUTTON',@lastid,'BUTTON_INVITE',1);
INSERT INTO pref_label_value (pref_label_name_id,label_value,lang,rendered) VALUES ((SELECT id FROM pref_label_name WHERE name = 'SOCIAL_ACQUAINTANCE_INVITE_RESET_BUTTON'),'Reset','en',true);
INSERT INTO pref_label_value (pref_label_name_id,label_value,lang,rendered) VALUES ((SELECT id FROM pref_label_name WHERE name = 'SOCIAL_ACQUAINTANCE_INVITE_RESET_BUTTON'),'Reajustar','es',true);
