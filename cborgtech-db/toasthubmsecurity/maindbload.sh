...
all() {
	load_main toasthubmsecurity_main localhost cyborg c7b8rg
	load_security toasthubmsecurity_main_internet localhost cyborg c7b8rg
	load_security toasthubmsecurity_main_garagecloud localhost cyborg c7b8rg
	}
